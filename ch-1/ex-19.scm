...
; be the special case of p = 0 and q = 1 in a family of transformations T_pq,
; where T_pq transforms the pair (a,b) according to a <- bq + aq + ap and
; b <- bp + aq. Show that if we apply such a transformation T_pq twice, the
; effect is the same as using a single transformation T_p'q' of the same form,
